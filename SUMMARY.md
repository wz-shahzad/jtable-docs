...
* [jTable Documentation](jtable-docs/README.md)
  ...
  * [api-reference](jtable-docs/api-reference/README.md "API References")
    ...
    * [Methods](jtable-docs/api-reference/methods.md "Methods")
    * [Events](jtable-docs/api-reference/events.md "Events")
    * [Localization](jtable-docs/api-reference/localization.md "Localization")
