...
See the [Themes & UI](../themes-ui/overview.md) section for full setup instructions per theme.
...
See the [Localization](../api-reference/localization.md) reference for available languages and how to write your own.
...
- [Quick Start](quick-start.md) — build a complete CRUD table step by step
